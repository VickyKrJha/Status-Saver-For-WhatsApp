...
import com.vickysg.whatsappstatussaver.adapter.SavedAdapter;
import com.vickysg.whatsappstatussaver.model.Status;
import com.vickysg.whatsappstatussaver.utils.Common;
...
public class SavedFilesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        InterstitialAd.load(getActivity(),"ca-app-pub-3912259549278001/5948264749", adRequest, new InterstitialAdLoadCallback() {
            @Override
